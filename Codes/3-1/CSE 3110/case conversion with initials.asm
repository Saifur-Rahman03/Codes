...
MSG1 DB 'ENTER THREE INITIALS OF YOUR NAME: $'       ;user prmopt message
MSG2 DB 0DH, 0AH, 'INITIALS OF NAME IN LOWERCASE: $' ;output message
MSG3 DB 0DH,0AH,'$'                                  ;new line string
